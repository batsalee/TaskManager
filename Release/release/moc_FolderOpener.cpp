/****************************************************************************
** Meta object code from reading C++ file 'FolderOpener.h'
**
...
#include "../../Qt/TaskManager/FolderOpener.h"
...
#error "The header file 'FolderOpener.h' doesn't include <QObject>."
...
static constexpr auto qt_meta_stringdata_CLASSFolderOpenerENDCLASS = QtMocHelpers::stringData(
    "FolderOpener",
    "openFolder",
    "",
    "path"
...
Q_CONSTINIT static const qt_meta_stringdata_CLASSFolderOpenerENDCLASS_t qt_meta_stringdata_CLASSFolderOpenerENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(13, 10),  // "openFolder"
        QT_MOC_LITERAL(24, 0),  // ""
...
void FolderOpener::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->openFolder((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    }
}
